<template>
  <div class="table">
    ...
    <el-table size="mini" border style="width: 100%" height="800px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="birth" label="生日" width="120px" align="center"></el-table-column>
    ...
    <el-dialog title="添加歌手" :visible="centerDialogVisible" width="400px" center>
    ...
    <el-dialog title="修改歌手" :visible.sync="editVisible" width="400px" center>
      <el-form :model="form" ref="form" label-width="80px">
        ...
        <el-form-item label="性别" size="mini">
          <el-radio-group v-model="form.sex" placeholder="歌手名">
            <el-radio :label="0">女</el-radio>
            <el-radio :label="1">男</el-radio>
            <el-radio :label="2">组合</el-radio>
            <el-radio :label="3">未知</el-radio>
        ...
        <el-form-item prop="birth" label="生日" size="mini">
          <el-date-picker type="date"  value-format="yyyy-MM-dd" v-model="form.birth" placeholder="选择日期" style="width: 100%;"></el-date-picker>
        </el-form-item>
...
import {getAllSinger,updateSinger,deleteSinger} from "../api/index";
    ...
    addSinger(){
      ...
      .then(res=>{
        if(res.code==1){
          ...
          this.$notify({title:"添加失败",type:"error"})
        }
      })
      .catch(err=>{
        console.log(err);
    ...
    editSave(){
      ...
      .then(res=>{
        if(res.code==1){
          ...
          this.$notify({title:"更新失败",type:"error"});
        }
      })
      .catch(err=>{
        console.log(err);
